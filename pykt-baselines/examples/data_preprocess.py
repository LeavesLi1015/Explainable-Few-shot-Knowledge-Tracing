...
from my_pykt.preprocess.split_datasets import main as split_concept
from my_pykt.preprocess.split_datasets_que import main as split_question
from my_pykt.preprocess import data_proprocess, process_raw_data
...
dname2paths = {
    ...
    # add my dataset: FrcSub, FrcSub_sparse, MOOCRadar, XES3G5M
    "FrcSub": "../data/FrcSub/",
