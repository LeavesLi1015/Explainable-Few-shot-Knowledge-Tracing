...
def main(dname, fname, dataset_name, configf, min_seq_len = 3, maxlen = 200, kfold = 5, train_test_split_ratio = 0.3):
    """split main function
    ...
    # train test split
    train_df, test_df = train_test_split(total_df, train_test_split_ratio)
