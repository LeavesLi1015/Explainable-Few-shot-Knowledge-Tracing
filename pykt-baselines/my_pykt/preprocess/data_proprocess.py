...
def process_raw_data(dataset_name,dname2paths):
    ...
    # add my dataset: FrcSub, FrcSub_sparse, MOOCRadar, XES3G5M, data.txt are already generated
    elif dataset_name in ["FrcSub","FrcSub_sparse","MOOCRadar","MOOCRadar-73","XES3G5M"]:
        pass
    else:
